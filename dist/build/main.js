    ...
    return {
        ...
        execute: function() {
            UserDetailsComponent = (function () {
                ...
                UserDetailsComponent.prototype.changeLanguage = function () {
                    var _this = this;
                    if (this.model.lang === 'ru') {
                        this._userServe.setUserLang('en');
                    }
                    else {
                        this._userServe.setUserLang('ru');
                    }
                    changeSets();
                    {
                        setTimeout(function () {
