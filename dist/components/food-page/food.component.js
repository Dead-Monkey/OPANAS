System.register(['angular2/core', '../../shared/services/translate/translate.service', '../../shared/components/progress-bar/progress-bar.component', '../add-food/add-food.component', '../../services/food/food.service', '../../shared/pipes/simple-search/simple-search.pipe', '../../services/calenadar/calendar.service', '../../services/user/user.service', '../../shared/directives/swipeHolder/swipe-holder.directive'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, translate_service_1, progress_bar_component_1, add_food_component_1, food_service_1, simple_search_pipe_1, calendar_service_1, user_service_1, swipe_holder_directive_1;
    var FoodComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            FoodComponent = (function () {
                ...
                FoodComponent.prototype.bla = function (e) {
                    console.log(e);
                };
                ...
                FoodComponent.prototype.addFoodToggle = function () {
                ...
                FoodComponent = __decorate([
                    core_1.Component({
                        selector: 'op-food',
                        directives: [progress_bar_component_1.ProgressBar, add_food_component_1.AddFoodComponent, swipe_holder_directive_1.SwipeHoldertDirective],
                        providers: [],
