System.register(['angular2/core', '../../shared/services/translate/translate.service', '../../shared/components/progress-bar/progress-bar.component', '../plus-bar/plus-bar.component', '../../shared/pipes/simple-search/simple-search.pipe', '../../services/calenadar/calendar.service', '../../services/user/user.service', '../../services/sport/sport.service', '../../shared/directives/swipe-delete-side/swipe-delete-side.directive', 'angular2/router'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, translate_service_1, progress_bar_component_1, plus_bar_component_1, simple_search_pipe_1, calendar_service_1, user_service_1, sport_service_1, swipe_delete_side_directive_1, router_1;
    var SportComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            SportComponent = (function () {
                function SportComponent(_sportServe, _calendarService, _userServe, _router) {
                ...
                SportComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [sport_service_1.SportService, calendar_service_1.CalendarService, user_service_1.UserService, router_1.Router])
                ], SportComponent);
